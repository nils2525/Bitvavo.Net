...
namespace Bitvavo.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IBitvavoUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, BitvavoCredentials credentials, BitvavoEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBitvavoRestClient GetRestClient(string userIdentifier, BitvavoCredentials? credentials = null, BitvavoEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBitvavoSocketClient GetSocketClient(string userIdentifier, BitvavoCredentials? credentials = null, BitvavoEnvironment? environment = null);
    }
}
